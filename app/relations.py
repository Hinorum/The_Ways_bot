...
#             корм Хозяина Ошибки, головная боль Архива;
...
_SHIFTS: dict[str, dict[str, int]] = {
    "care": {"liner": 1, "archivist": 1, "master": -1, "heretic": 0},
    "cunning": {"liner": 1, "archivist": -1, "master": 1, "heretic": 1},
    "risk": {"liner": -1, "archivist": 0, "master": 1, "heretic": 1},
}
...
NPC_WANTS = {
    "liner": (
        ...
        "радио на его бедре молчит годами — но он ищет того, кто услышит в нём первый Лай",
    ),
    "archivist": (
        "ищет страницу, которую сам же вычеркнул из канона",
        "проверяет счёт стаи в третий раз — где-то он разошёлся",
        "хочет узнать, что стая помнит иначе, чем его папки",
        "не может закрыть папку Сигнала: два стекла очков показывают две разные версии, и ни одну он не выбирает",
    ),
    "master": (
