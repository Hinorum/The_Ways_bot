...
DM_SYSTEM_PROMPT = (
    ...
    "жестокость тоже. Пять собак стаи — Баркод, Миска, Вектор, Пиксель и Безымянная — остаются фоном: "
    "именная деталь раз в несколько дней («Стежкин нос в золе»), но не главные герои.\n"
