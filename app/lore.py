...
WORLD_BIBLE = (
    "Мир называется Эхо Стаи — лабиринт нестабильных порталов, где каждый коридор собран из чужих решений. "
...
_CUNNING_PATHS = [
    ...
    (
        ...
        "Двойник ушёл в портал. Администратор пересчитал стаю и сбился со счёта.",
    ),
    (
