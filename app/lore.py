...
def _law_voice(win_rule) -> str:
    """Закон дня репликой Архивариуса — даже без нейросети.
    ...
    Архивариус — хозяин лабиринта, выбирает какой коридор открыть.
    """
