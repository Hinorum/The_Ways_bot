...
def _chapter_text(
    ...
    closings = [
        ...
        (
            ...
            "покажут только в итогах. Баркод тихо скулит — собаки чувствуют развилки раньше нас."
        ),
        (
        ...
        (
            "Миски расставлены полукругом, карты лежат в центре — так стая решала "
            "ещё до порталов. Сутки времени, счёт спрятан, закон известен. Вектор "
            "обошёл карты по кругу и не тронул ни одну: даже он понимает вес выбора."
        ),
        (
            "Сутки до закрытия развилки. Архив уже приготовил пустую папку дня — "
            "в неё ляжет то, что стая решит сейчас, и станет правдой навсегда. "
            "Пиксель ловит лапой цифровой дождь: мир нервничает не меньше стаи."
        ),
        (
            "Один день — один выбор на всю стаю. Цифры не покажут до итогов, "
            "закон объявлен с утра. Порталы сегодня гудят на грани слышимости: "
            "сеть затаила дыхание и ждёт, куда вы шагнёте."
        ),
        (
            "До заката развилки — сутки. Что бы ни выбрала стая, завтрашнее утро "
            "будет жить по этим правилам: так работает память мира. Лайнер где-то "
            "рядом пересчитывает выручку чужих снов и усмехается: он знает цену ожидания."
        ),
        (
            "Три карты, одни сутки, скрытый счёт. Стая легла вокруг развилки кругом — "
            "морды наружу, как учат старые тропы. Ночью кто-то из собак вздрагивал "
            "во сне: приметы сошлись слишком плотно. Утром решать вам."
        ),
        (
            "Развилка открыта ровно на сутки. Закон известен с рассвета, счёт увидим "
            "только вечером. Стежка уронила карту, подняла её той же стороной, что "
            "лежала, — суеверие или знак. В мире порталов это одно и то же."
        ),
        (
            "Сутки на размышление. Победивший путь впечатается в реальность до того, "
            "как остынут миски, — так здесь устроено. Хозяин Ошибки сегодня не "
            "пересчитывал стаю: значит, его интересует именно этот выбор. Решайте тихо."
        ),
    ]
