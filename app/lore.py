...
_CARE_PATHS = [
    ...
    (
        ...
        "Стена стоит. Та пара теперь спит спокойно — а стая стала чуть ближе друг к другу.",
    ),
    (
        "Дымящийся след",
...
_CUNNING_PATHS = [
    ...
    (
        ...
        "Старая версия восстановлена. В ней стая ещё не существовала — и это было бы удобно.",
    ),
    (
        "Чужая карта",
