...
class Settings(BaseSettings):
    ...
    # Максимальная сумма одной выплаты (Gram): защита от повреждения БД или
    # ошибки в расчёте. Выплата больше этой суммы не отправляется, помечается
    # failed. 0 = без ограничения.
    max_payout_gram: float = 1000.0
