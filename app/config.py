...
class Settings(BaseSettings):
    ...
    # мест «1-е,2-е,3-е» в процентах. Дополнительно для выплаты нужна
    # хотя бы одна ставка в этой неделе (и в каждом новом периоде — заново).
    ...
    # Пример: "60,30,10" → три получателя с весами 60%/30%/10%.
    monthly_prize_top_k: int = 1
    monthly_prize_weights: str = "100"
