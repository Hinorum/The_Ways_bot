...
class Settings(BaseSettings):
    ...
    # обложка, прегенерация, пост нового дня).
    ...
    world_brief: str = (
        ...
        "Хозяин Ошибки, мечтающий вернуть всем ровный сон без единой ошибки. Стая проходила "
        "этот месяц много раз, и сансара помнит её: в подвале сети живёт Крыса — память стёртых "
        "кругов, она помнит все прошлые выборы и финалы. На последний день месяца к порталу "
        "встаёт Анубис — судья самого цикла: он взвешивает счёт против выбора и решает, "
        "разомкнётся ли петля. День Первого Лая — суд: что стая кладёт на чашу, то и станет "
        "осадком следующего круга."
    )
