...
class Settings(BaseSettings):
    ...
    # True (новое правило) / False (прежний чисто-подсчётный исход).
    winner_by_stakes: bool = True
    # Легаси (работает только при winner_by_stakes=False):
    ...
    # Легаси-приоритет ставящих при выборе пути дня (защита от MINORITY-патологии).
