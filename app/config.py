...
class Settings(BaseSettings):
    ...
    world_brief: str = (
        ...
        "Архивариус Хранитель Спорных Версий видит обе версии каждого дня — записанную "
        "и помнитую стаёй — и торгует расхождениями между ними. Он не врёт, но говорит "
        "полуправдами: его очки-лупы показывают разный текст в каждом стекле. Стая "
