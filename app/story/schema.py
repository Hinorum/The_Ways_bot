...
# Стоп-слова: реальные бренды/криптобиржи/обещания дохода + канон
# «Lost Dogs: The Way», который мы не наследуем дословно. Эвристика — подстрока
# в нижнем регистре; совпадение = кассета отвергнута.
TABOO_WORDS = (
    "догтаун",
    "dogtown",
    "woof",
