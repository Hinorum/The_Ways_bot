...
def _bot_description() -> str:
    base = (
        ...
        "Каждый день — сцена: ты голосуешь один из трёх черновиков кадра.\n"
        "Закон дня (большинство, меньшинство или середина) решает движок;\n"
        "проигравшие черновики остаются шрамом на плёнке в следующих сценах.\n"
    )
    hints = []
