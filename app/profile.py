...
BOT_ABOUT = (
    "Ведущий Пепельного Тракта: каждый день — три пути "
    "и один канон. Голосуй, ставь — история помнит всё."
)

# Приветственный экран пустого чата («Что умеет этот бот?»), лимит 512.
BOT_DESCRIPTION = (
    "Ты — голос безымянной стаи на вечном Тракте.\n\n"
    "Каждое утро колокол объявляет закон дня, нейросеть пишет главу — "
    ...
    "Нажми START: Тракт уже ждёт."
)

# Личный чат: полный список. /advance хранителя сюда не попадает.
PRIVATE_COMMANDS = [
    BotCommand(command="start", description="Открыть Тракт"),
