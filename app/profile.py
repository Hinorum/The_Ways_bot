...
def _bot_description() -> str:
    base = (
        "Ты — голос стаи в лабиринте нестабильных коридоров.\n"
        "Каждое утро Архивариус выносит три тропы и объявляет закон дня. "
        "Он видит обе версии и торгует расхождениями между ними.\n"
        "Победивший путь впечатается в мир. Завтрашняя глава вырастет из "
        "того, что ты выберешь сейчас.\n"
        "В стенах — Крыса, память стёртых кругов. В последний день месяца "
        "у двери встаёт Анубис, судья цикла.\n"
    )
    hints = []
