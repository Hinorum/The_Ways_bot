...
BOT_ABOUT = (
    ...
    "Голосуй — а в последний день месяца сансару взвесит суд."
)
...
def _bot_description() -> str:
    base = (
        ...
        "Мир помнит всё: даже невыбранные тропы оставляют след. В подвале — "
        "Крыса, память стёртых кругов. В последний день месяца к порталу встаёт "
