...
# Шаблон дня: без нейросети и арта день жил бы пустым. Три постоянные тропы,
...
_TEMPLATE_CARDS: list[dict] = [
    {
        "position": 0,
        "title": "Путь I",
        "description": "Первая тропа для голоса стаи.",
        "consequence": "Стая выбрала первую тропу.",
        "tag": "care",
        "image_path": "",
    },
    {
        "position": 1,
        "title": "Путь II",
        "description": "Вторая тропа для голоса стаи.",
        "consequence": "Стая выбрала вторую тропу.",
        "tag": "care",
        "image_path": "",
    },
    {
        "position": 2,
        "title": "Путь III",
        "description": "Третья тропа для голоса стаи.",
        "consequence": "Стая выбрала третью тропу.",
        "tag": "care",
        "image_path": "",
    },
]
