...
async def cmd_start(message: Message) -> None:
    ...
    lines = [
        ...
        "",
        "Каждый день — одна сцена. Ты выбираешь один из трёх черновиков",
        "кадра; закон дня считает честная энтропия: день Грома, Шёпота",
        "или Середины. Уцелевший черновик едет в сценарий дальше.",
    ]
    if settings.ton_enabled:
        lines.append(
