...
_STAKE_HOWTO = (
    "У Вокзала ничего не берётся просто так: грамм, который стая бросает в котёл "
    "за тропу, Котёл запоминает как запах того, кто верит в день. Так платят за "
    "то, во что верят, — мир держит клятву тем усерднее, чем весомее было вложение.\n\n"
    "{mark} Ставка на тропу — три шага:\n"
    ...
    "3. Нажми кнопку с тропой дня — когда угодно до закрытия голосования.\n\n"
