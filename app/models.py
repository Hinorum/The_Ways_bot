...
RULE_PHRASES = {
    WinRule.MAJORITY: "побеждает тропа с большей суммой Gram (день Грома)",
    WinRule.MINORITY: "побеждает тропа с меньшей суммой Gram (день Шёпота)",
    WinRule.MEDIAN: "побеждает тропа со средним весом Gram (день Середины)",
}
...
VOTE_RULE_PHRASES = {
    WinRule.MAJORITY: "побеждает тропа, собравшая больше всех голосов",
    WinRule.MINORITY: "побеждает тропа, собравшая меньше всех голосов",
    WinRule.MEDIAN: "побеждает тропа со средним числом голосов",
}
