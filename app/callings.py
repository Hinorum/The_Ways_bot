...
ECHO_TAILS: dict[str, str] = {
    "hound": "След не остывает — ты его уже читаешь.",
    "guardian": "Стая помнит тех, кто шёл с сердцем.",
    "trickster": "Тихие тропы тоже приводят домой.",
    "archivist": "Где-то в папке архива уже лежит и этот день.",
    "bard": "Об этом ещё споют у порталов.",
    "mutant": "Слепые дни иногда видят точнее всех.",
    "heretic": "Твой путь никто не отменял — его просто не поняли.",
}
